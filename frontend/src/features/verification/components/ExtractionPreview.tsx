...
export function ExtractionPreview({
    ...
    const [editedGuideData, setEditedGuideData] = useState<Record<string, any>>({})
    const [editedOtherData, setEditedOtherData] = useState<Array<{ column: any; value: any }>>([])
    ...
    useEffect(() => {
        setEditedGuideData({ ...guideExtracted })
    }, [guideExtracted])
